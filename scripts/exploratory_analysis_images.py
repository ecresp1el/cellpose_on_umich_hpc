...
# Your adapted TNIA helper (existing)
from cp_core.helper_functions.dl_helper import quantile_normalization

# Reuse shared helpers you just added to dl_helper
...
def find_image_and_label(
    ...
    """
    Resolve image and label paths given a stem (YAML suffix preferred; fallbacks allowed).
    ...
    # Label presence via shared pairing helper
